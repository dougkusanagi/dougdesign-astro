...
A franquia Pokémon é um dos pilares da Nintendo, atraindo milhões de jogadores em todo o mundo. Qualquer novidade nesse universo tem um impacto significativo no mercado de games e, especialmente, para os fãs brasileiros, que aguardam ansiosamente por títulos que explorem todo o potencial do hardware.

## O que aconteceu

Atualmente, não há um anúncio oficial de um novo jogo Pokémon especificamente para o Nintendo Switch 2. No entanto, o ciclo de vida dos consoles e as constantes atualizações de jogos populares como Pokémon Scarlet e Violet, além de títulos como `Xenoblade Chronicles™: Definitive Edition – Nintendo Switch™ 2 Edition` que já aparecem associados ao futuro console no site oficial da Nintendo, alimentam as especulações. A Nintendo tem um histórico de lançar jogos Pokémon importantes em seus novos hardwares, e a expectativa é que isso se repita com o sucessor do Switch.
...
Falta a confirmação oficial de um novo título principal da série Pokémon para o Switch 2. Também não há detalhes sobre o tipo de jogo, se será uma nova geração, um spin-off ou uma versão aprimorada de títulos existentes. A data de lançamento e a janela de chegada ao Brasil são completamente desconhecidas.
...
A Nintendo raramente decepciona quando se trata de Pokémon. A estratégia da empresa é clara: lançar o Switch 2 com um forte título de Pokémon para impulsionar as vendas iniciais. É quase certo que veremos um novo jogo principal, e a expectativa é que ele seja ambicioso, explorando as capacidades do novo console. A ausência de anúncios pode ser uma tática para manter o mistério e gerar mais expectativa. Para os fãs brasileiros, a boa notícia é que a Nintendo tem dado cada vez mais atenção ao nosso mercado, então é provável que tenhamos acesso ao jogo em um tempo razoável após o lançamento global, com suporte ao nosso idioma.
