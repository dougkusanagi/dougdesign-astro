...
Nesta nova geração, The Rockstar Games inseriu um motor LLM dedicado leve no código-fonte, permitindo que personagens não jogáveis tomem decisões baseadas no que veem. Eles escutam o rádio da sua frota policial, lembram-se de interações com o player no passado e modificam o diálogo dinamicamente. Um civil que você agrediu na terça-feira no jogo lembrará do seu rosto na quinta-feira de um modo bizarramente natural.

Essa nova camada de "Inteligência Simulada" muda as regras dos mundos abertos para sempre de maneira nunca vista, exigindo hardwares pesados e novos parâmetros das concorrentes.
