...
draft: false
readingTime: 5 min
slug: valor-mortis-summer-game-fest-radar
scheduled: false
...
No dia 27 de abril de 2026, o Xbox Wire publicou a lista de jogos e estudios que vao aparecer no Summer Game Fest Play Days 2026. Entre os nomes citados esta Valor Mortis, associado ao estudio One More Level.

Na mesma publicacao, o jogo foi descrito de forma bem direta: um soulslike em primeira pessoa ambientado em uma era napoleonica fantastica, com poderes sobrenaturais e swordplay intricado. Nao houve, nesse resumo, anuncio de data, plataformas, preco ou janela comercial.

## O que ja da para cravar

O que esta confirmado pela fonte oficial e o seguinte:

- Valor Mortis faz parte da lista oficial de demos destacadas pelo Xbox no Summer Game Fest Play Days 2026.

- O estudio citado para o jogo e a One More Level.

- A proposta descrita oficialmente mistura soulslike em primeira pessoa, era napoleonica fantastica, poderes sobrenaturais e combate de espada detalhado.

So isso ja coloca o jogo numa faixa interessante de observacao. Ha um recorte de identidade claro, e isso pesa mais do que muito anuncio que so vende clima. O problema e que ainda estamos no nivel de pitch jogavel, nao de pacote comercial fechado.

## O que ainda depende de prova

Ainda faltam informacoes essenciais para transformar curiosidade em decisao segura:

- plataformas confirmadas;

- data ou janela de lancamento;

- escopo da demo e recepcao pratica fora do texto promocional;

- ritmo real de combate em primeira pessoa;

- nivel de dificuldade e acessibilidade;
...
Minha leitura e que Valor Mortis merece entrar no radar, mas com freio puxado. O conceito oficial e bom o bastante para justificar wishlist: primeira pessoa, fantasia napoleonica e poderes sobrenaturais formam uma combinacao menos generica do que parece. Para mim, o ponto decisivo e se esse combate de espada em primeira pessoa vai entregar clareza e peso, porque e ai que muito jogo promissor tropeca.

Se voce gosta de soulslike e costuma acompanhar demo por demo, eu colocaria na wishlist sem drama. Se voce so entra quando ja existe data, plataforma e impressao tecnica mais concreta, eu esperaria. Hoje, o jogo vende uma boa ideia. Ainda nao vende uma decisao de compra.
