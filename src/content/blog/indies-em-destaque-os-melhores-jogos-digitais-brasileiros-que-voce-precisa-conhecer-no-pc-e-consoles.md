...
O principal desafio para o consumidor ainda é a visibilidade. Muitos jogos digitais brasileiros excelentes acabam soterrados pelo algoritmo das grandes lojas digitais, exigindo um esforço ativo de busca do jogador. Além disso, como a maioria é feita por equipes independentes de tamanho reduzido, o suporte pós-lançamento e atualizações podem demorar mais do que em produções de grandes estúdios. Por fim, a precificação em consoles às vezes sofre com a conversão direta de moedas, tornando a versão de PC via Steam frequentemente mais vantajosa financeiramente para o público local.
