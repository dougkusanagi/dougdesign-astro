...
Final Fantasy VII Rebirth no Switch 2 é uma daquelas chegadas que ajudam a medir a ambição do console. Não é um indie leve, nem um port simbólico. É RPG grande, cinematográfico, com expectativa técnica e de armazenamento.

Para o jogador brasileiro, a notícia boa não vem sozinha. A mesma página que anima pelo suporte e pela plataforma também obriga a olhar espaço interno, cartão microSD Express e tamanho real da biblioteca digital.
...
O oficial é a listagem na loja da Nintendo, a plataforma Switch 2, o preço em dólar exibido e a presença de página localizada para o Brasil. A página pública também confirma que se trata de um RPG grande da Square Enix no novo console da Nintendo.

## O que ainda falta confirmar

Ainda falta o que mais importa para compra no Brasil: preço local, mídia física ou Game-Key Card em varejo, desempenho real no modo portátil e dock, estabilidade de frame rate e comparação com PS5.

Também vale observar se o download final e eventuais updates pesam mais do que o indicado inicialmente. Em Switch 2, isso define se o jogador consegue manter vários jogos grandes instalados.
...
Eu vejo Rebirth no Switch 2 como sinal forte de biblioteca, mas não como compra automática para todo mundo. Se você já jogou no PS5, espere comparação técnica. Se nunca jogou e quer portátil, ele pode ser um dos grandes argumentos do console.

O detalhe decisivo é armazenamento. Um jogo desse tamanho torna o cartão de memória menos opcional, e isso muda preço real para o brasileiro.
...
- [Página oficial de Final Fantasy VII Rebirth na Nintendo](https://www.nintendo.com/us/store/products/final-fantasy-vii-rebirth-switch-2/)
