...
O sinal mais forte do preview e que a IO nao esta tentando fazer apenas um filme jogavel. O texto oficial fala em liberdade para abordar problemas de varios angulos, mudanca rapida entre furtividade e combate e muito uso de improviso. Isso importa porque James Bond em jogo costuma desandar quando vira corredor de set piece. Aqui, pelo menos no material oficial, a equipe parece ter entendido que Bond precisa soar esperto, nao so caro.

Tambem ajuda o fato de o jogo partir de uma historia de origem. O Bond de First Light ainda erra, ignora ordens e age no impulso. Para um jogo, isso e melhor do que o espiao perfeito demais, porque abre espaco para missao que mistura disfarce, conversa, fuga e porrada sem parecer incoerente.

## O que a IO Interactive ja colocou na mesa

Segundo o hands-on, a primeira missao se passa na Islandia, depois ha um treino em Malta e por fim uma missao mais aberta em Londres. O PlayStation Blog descreve Q Lens para marcar inimigos e dispositivos, relogio com laser, dardos para distrair NPCs, luta corpo a corpo com bloqueio e parry e um trecho de gala em museu com cara de "wide-linear", bem proximo da escola Hitman.

O ponto que mais me chamou atencao nao foi a lista de ferramentas, e sim a combinacao delas. O texto oficial insiste que a graca esta em encadear opcoes na hora: derrubar lustre, hackear algo para distrair, sair do stealth para o combate e voltar a sumir. Se isso funcionar no jogo completo, First Light pode escapar da armadilha de ser "Hitman com skin de Bond" e encontrar identidade propria.
...
- PlayStation Blog: https://blog.playstation.com/2026/04/30/007-first-light-hands-on-report-using-stealth-action-and-charm-to-become-a-legendary-spy/
