...
draft: false
readingTime: 4 min
slug: doom-the-dark-ages-no-xbox-game-pass-tudo-o-que-sabemos-sobre-o-lancamento-day-one
scheduled: false
...
## Os detalhes medievais e plataformas confirmadas pela id Software

A id Software revelou que o combate trara novas armas inspiradas na era medieval, com destaque para um escudo equipado com dentes de motosserra e um mangual devastador. Essas ferramentas mudam a dinamica tradicional de tiro em primeira pessoa, adicionando mais opcoes de combate corpo a corpo e defesa ativa.

Em termos de plataformas, o titulo estara disponivel para: * Xbox Series X|S (com suporte ao Cloud Gaming no lancamento) * PC (atraves do Game Pass para PC)

Com isso, o ecossistema Xbox cobre tanto os jogadores de console quanto os de computador, alem de permitir o acesso via nuvem para quem nao possui o hardware de ultima geracao.

## Quem precisa decidir entre assinar ou comprar o jogo isolado

Para quem joga no ecossistema Xbox ou PC, o lancamento direto no servico elimina a necessidade de pagar o preco cheio de um lancamento triplo A. No entanto, quem joga no PlayStation precisa avaliar as alternativas de servicos concorrentes, analisando as diferencas de planos como os detalhados no guia sobre [ps plus essential extra deluxe qual plano escolher 2026](https://www.dougdesign.com.br/ps-plus-vs-xbox-game-pass-2026-qual-assinatura-vale-mais/) para entender se vale manter multiplas assinaturas ativas.
...
## Minha leitura: O peso de Doom no Game Pass contra a concorrencia

A inclusao de Doom: The Dark Ages no day one e um movimento certeiro que mantem o Game Pass competitivo. Enquanto outras plataformas focam em catalogos rotativos de jogos mais antigos, a Microsoft aposta alto na entrega imediata de blockbusters. Para o jogador brasileiro, que enfrenta precos elevados em lancamentos fisicos e digitais, o custo-beneficio de jogar no dia um atraves da assinatura e imbativel.

Minha recomendacao e clara: se voce ja e assinante ativo do plano Ultimate ou PC, nao ha razao para esperar. Jogue no primeiro dia e aproveite o investimento. Se voce nao assina o servico, vale a pena pagar um unico mes para terminar a campanha e depois avaliar se mantem a assinatura ativa, em vez de pagar o valor cheio do jogo em plataformas onde ele nao esta incluso no catalogo de assinaturas.

## Fonte

Para mais detalhes oficiais, acesse o [Xbox Wire](https://news.xbox.com/).
