...
3. `editorial/docs/01-principios.md`
...
- Never publish multiple evergreen posts at the exact same time. Maintain a sustainable cadence of 2–3 quality posts per week; use 08:00, 12:00 and 18:00 local time as staggered slots when appropriate, via `dougseo schedule --slug <slug> --at <ISO_DATE>`.
